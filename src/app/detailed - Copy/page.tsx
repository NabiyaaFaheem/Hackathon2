...
import { FaChevronCircleDown, FaHeart, FaStar } from 'react-icons/fa';
...
<p className=' text-gray-400 ml-5'>440+ Reviewer</p>
    ...
    <p className=' text-gray-500 mt-8 ml-6'>NISMO has become the embodiment of Nissan's outstanding performance, inspired by the most unforgiving proving ground, the "race track".</p>
